    ...
    <div>
      <div className="h-[100vh] flex items-center justify-center w-full overflow-x-hidden">
        <Image
          ...
          alt="hero"
          className="lg:object-cover max-lg:hidden object-fill bg-c bg-center relative w-full h-full"
        />
        <Image
          src={Hero2}
          alt="hero"
        ...
        <div className="absolute max-md:mt-10 w-full bottom-10 flex flex-col gap-5 justify-center text-white px-6 lg:px-32">
          <div className="w-full flex flex-col gap-5 justify-center text-white">
            <p
              className="lg:text-lg relative pb-4"
            ...
            <p
              ...
              data-aos-delay="500"
            >
              Join us as we build a vibrant community rooted in faith, hope, and
              love. Explore our inspiring resources, including devotionals,
              apparel, and more, to support your spiritual journey.
            </p>
          </div>
          <div
            className="flex max-md:w-full flex-col lg:flex-row items-center lg:gap-6 gap-3"
            data-aos="zoom-out"
          >
            ...
            <a
              href="https://music.apple.com/gh/artist/nii-kwei/1757263757"
              className="flex flex-col lg:flex-row gap-4 mt-4"
            >
              <button className="bg-gradient-to-r from-purple-500 to-pink-500 px-8 py-3 rounded-full font-semibold hover:scale-105 transition">
                🎧 Listen Now
              </button>

              <a
                href="https://www.youtube.com/@niikweimusic"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-16 lg:px-20 px-6 py-10">
        ...
        <div className="order-1 lg:order-2" data-aos="fade-left">
          <div className="flex flex-col gap-4">
            ...
            <p className="text-lg">
              We are a dynamic ministry dedicated to spreading the gospel
              through worship, outreach, and community service. Our mission is
              to transform lives and make a lasting impact in our community and
              beyond.
            </p>
            <Link
              href="/about"
              className="bg-button border border-button py-2 px-6 text-lg rounded-md hover:bg-purple-500 duration-300 ease-linear text-white text-center lg:w-fit"
            >
              Read More
            </Link>
          </div>
      ...
      <div className="flex flex-col lg:items-center py-20 lg:py-40 px-6">
        ...
        <EventCard />
        <Link href="/event">
          <button className="text-button max-lg:text-center max-lg:w-full">
            View All Events {">"}
          </button>
        </Link>
      </div>
      ...
      <div className="flex items-center justify-center w-full max-lg:h-[40vh]">
        <Image
          src={Banner}
          alt="banner"
          className="bg-cover max-lg:hidden bg-center relative w-full h-full"
        />
        <Image
          src={Banner2}
          alt="banner"
          className="bg-cover lg:hidden bg-center relative w-full h-full"
        />
        ...
        <div className="absolute max-md:mt-10 w-full flex flex-col gap-5 items-center justify-center text-white px-6 lg:px-20">
          <h1
            className="text-3xl lg:text-5xl font-semibold lg:w-[40%] text-center leading-none"
            data-aos="zoom-in"
          >
            Get Involved And Make A Difference
          </h1>
          <p
            className="lg:w-[60%] text-center max-lg:text-sm"
            data-aos="zoom-in"
          >
            Join our community of passionate volunteers and help us transform
            lives through service and worship.
          </p>
          <Link
            href="/volunteer"
            className="bg-gradient-to-r from-purple-500 to-pink-500 px-10 py-3 rounded-full text-lg font-semibold hover:scale-105 transition"
            data-aos="zoom-in"
          >
            Join The Movement
          </Link>
